        ...
        <tbody>
          ...
          <tr v-else v-for="user in users" :key="user.id">
            ...
            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
              <button class="text-indigo-600 hover:text-indigo-900 mr-4 disabled:opacity-50" :disabled="user.username === 'admin'">編輯</button>
              <button class="text-red-600 hover:text-red-900 disabled:opacity-50" :disabled="user.username === 'admin'">刪除</button>
            </td>
          </tr>
        </tbody>
      </table>
